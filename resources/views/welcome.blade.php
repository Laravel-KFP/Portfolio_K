...
<header id="header">
	<div id="head" class="parallax" parallax-speed="2">
		...
		<h1 id="logo" class="text-center">
			...
			<a href="">tanabut.ngo@gmail.com</a></span>
		</h1>
	</div>
			...
			<div class="thumbnails recentworks row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<a class="thumbnail" href="sidebar-right.html">
						<span class="img">
							<img src="image/phototo.png" alt="">
							<span class="cover"><span class="more">See details &rarr;</span></span>
						</span>
						<span class="title">Web application of Photo platform and communication</span>
					</a>
					<span class="details"><a href="">Web design</a> | <a href="">React.js</a> | <a href="">Sanity</a></span>
					<h4></h4>
					<p></p>
				</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<a class="thumbnail" href="sidebar-right.html">
						<span class="img">
							<img src="image/comap.png" alt="">
							<span class="cover"><span class="more">See details &rarr;</span></span>
						</span>
						<span class="title">Mobile application of covid visualization (@COMAPOFFICIAL) </span>
					</a>
					<span class="details"><a href="">Mobile Application</a> | <a href="">React Native</a></span>
					<h4></h4>
					<p></p>
				</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<a class="thumbnail" href="sidebar-right.html">
						<span class="img">
							<img src="image/Foodtu.png" alt="">
							<span class="cover"><span class="more">See details &rarr;</span></span>
						</span>
						<span class="title">Web application of food delivery in Thammasat University</span>
					</a>
					<span class="details"><a href="">Web design</a> | <a href="">React.js</a> | <a href="">Sanity</a></span>
					<h4></h4>
					<p></p>
		...
		<div class="row">
			<div class="col-md-3 widget">
				...
				<div class="widget-body">
					<p>+66 94 006 7350<br>
						<a href="mailto:#">tanabut.ngo@gmail.com</a><br>
						<br>
						71 Village No.17, Khlong Nueng, Khlong Laung, Pathum Thani 12120
					</p>	
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 widget">
				<div class="widget-body">
					<p>71 Village No.17, Khlong Nueng, Khlong Laung, Pathum Thani 12120 </p>
				</div>
			</div>
			...
			<div class="col-md-6 widget">
				<div class="widget-body">
					<p class="text-right">
						Copyright &copy; 2022, Tanabut<br> 
				</div>
			</div>
